				...
				<div className="row">
					<div className="col-lg-8 col-md-12 pr-lg-6">
								...
								{ cartItems &&
									 cartItems.map((cartItem) => (
										<tr>
											...
											<td className="product-name">
												<div className="product-name-section">
                                                    <a href="product-simple.html">{cartItem.product.name}</a>
												</div>
											</td>
											<td className="product-subtotal">
                                                <span className="amount">${ cartItem.product.base_price }</span>
											</td>
											<td className="product-quantity">
												<div className="input-group">
													<button className="quantity-minus p-icon-minus-solid"></button>
											...
											<td className="product-price">
                                                 <span className="amount">${ cartItem.quantity * cartItem.product.base_price }</span>
											</td>
											<td className="product-remove">
												<a
													href="#"
						...
						<div className="cart-actions mb-6 pt-6">
							<a
								href="shop.html"
								className="btn btn-dim btn-icon-left mr-4 mb-4"
							>
