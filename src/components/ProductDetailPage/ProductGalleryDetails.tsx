    ...
    return (
			...
			<h1 className="product-name">{ product?.name || "Banana from indonesia"}</h1>
				...
				<ul className="list list-circle">
					...
					<li>
						<i className="far fa-circle"></i>Eget sit amet tellus cras
						adipiscing enim eu.
					</li>
					<li>
						<i className="far fa-circle"></i>Tellus rutrumn tellus pellentesque
						eu tincidunt tortor
					</li>
				</ul>
				...
				<div className="product-form product-qty pt-1">
					<div className="product-form-group">
						...
						<button className="btn-product btn-cart ls-normal font-weight-semi-bold">
