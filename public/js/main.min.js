	...
	(function () {
		...
		(Panda.$window = $(window)),
			...
			(Panda.getCookie = function (t) {
				for (
					var e = t + "=", a = document.cookie.split(";"), n = 0;
					n < a.length;
					++n
				) {
			...
			(Panda.isOnScreen = function (t, e, a) {
				...
				return (
					r + s.height + l >= i &&
					r <= i + window.innerHeight + l &&
					o + s.width + d >= n &&
					o <= n + window.innerWidth + d
				);
			}),
			(Panda.doLoading = function (t, e) {
				var a = Panda.$(t);
				void 0 === e
					? a.append('<div class="loading"><i></i></div>')
					: "small" == e
					? a.append('<div class="loading small"><i></i></div>')
					: "simple" == e && a.append('<div class="loading small"></div>'),
					"static" == a.css("position") &&
						Panda.$(t).css("position", "relative");
			}),
			...
			(Panda.appear =
				...
				function (t, i, s) {
					...
					s &&
						(s.data && (o.data = s.data),
						s.accX && (o.accX = s.accX),
						s.accY && (o.accY = s.accY)),
						e.push({ el: t, fn: i, options: o }),
						a || (a = Panda.requestTimeout(n, 100));
				})),
			...
			(Panda.zoomImage = function (t) {
				$.fn.elevateZoom &&
					...
					Panda.$(t)
						...
						.each(function () {
							var t = $(this);
							(Panda.defaults.zoomImage.zoomContainer = t.parent()),
								t.elevateZoom(Panda.defaults.zoomImage),
								Panda.zoomImageObjects.push(t);
						});
			}),
			...
			(Panda.countTo = function (t) {
				$.fn.numerator &&
					Panda.$(t).each(function () {
						var t = $(this),
							e = {
								fromValue: t.data("fromvalue"),
								toValue: t.data("tovalue"),
								duration: t.data("duration"),
								delimiter: t.data("delimiter"),
								rounding: t.data("round"),
							};
						$.extend(e, {
							onProgress: function () {
								t.data("append") && t.html(t.html() + t.data("append")),
									t.data("prepend") && t.html(t.data("prepend") + t.html());
							},
						}),
					...
					Panda.$(t).each(function () {
						var t = $(this),
							a = $.extend(
								...
								Panda.parseOptions(t.attr("data-grid-options")),
								e || {}
							);
						Panda.lazyload(t),
				...
				$.fn.themePluginParallax &&
					Panda.$(t).each(function () {
						...
						t.themePluginParallax(
							$.extend(
								!0,
								Panda.parseOptions(t.attr("data-parallax-options")),
								e
							)
						);
					});
			...
			(Panda.initFloatingElements = function (t) {
				$.fn.parallax &&
					Panda.$(t).each(function () {
						var t = $(this);
						t.attr("data-floating-depth")
							? t
									.children(".layer")
									.attr("data-depth", t.attr("data-floating-depth"))
							: t.children(".layer").attr("data-depth", ".3"),
							t.parallax(t.data("options"));
					});
			}),
				...
				if (!Panda.isMobile && "undefined" != typeof skrollr) {
					...
					e.each(function () {
						var t = $(this),
							...
							a = [];
						t.data("options") &&
							((e = t.data("options")), (a = Object.keys(e))),
							"object" == typeof e &&
					...
					var a,
						...
						s = function () {
							...
							e.hasClass("has-dropdown")) &&
								e.find(".category-dropdown .dropdown-box").length &&
								(n += e.find(".category-dropdown .dropdown-box")[0]
									.offsetHeight);
							!i &&
								window.innerWidth >=
									Panda.defaults.stickyHeader.activeScreenWidth &&
								((i = !0),
								e.wrap(
								...
								Panda.$window.off("resize", s);
						},
						o = function () {
							window.innerWidth >=
								Panda.defaults.stickyHeader.activeScreenWidth &&
							window.pageYOffset >= n
								? (e[0].classList.add("fixed"),
								  document.body.classList.add("sticky-header-active"))
								: (e[0].classList.remove("fixed"),
								  document.body.classList.remove("sticky-header-active"));
						};
					window.addEventListener("scroll", o, { passive: !0 }),
						Panda.$window.on("resize", s),
						Panda.$window.on("resize", o),
						Panda.call(s, 500),
						Panda.call(o, 500);
				}
			}),
							...
							(t && !t.isTrusted) ||
								a.each(function (t) {
									var e = $(this),
										a = !0;
									n.scrollMode &&
										((a = i > window.pageYOffset), (i = window.pageYOffset)),
										...
										window.innerWidth <= n.maxWidth
											? (e.hasClass("fix-top")
											  ...
											  n.scrollMode
													? (a && e.hasClass("fix-top")) ||
													  (!a && e.hasClass("fix-bottom"))
														? (e.addClass("fixed"),
														  e
					...
					e.hasClass("expanded")
						? (n.removeClass("collapse").addClass("expand"),
						  e.addClass("collapsing").slideUp(300, function () {
								e.removeClass("expanded collapsing").addClass("collapsed"),
									a && a();
						  }))
						: e.hasClass("collapsed") &&
						  (n.removeClass("expand").addClass("collapse"),
						  e.addClass("expanding").slideDown(300, function () {
								e.removeClass("collapsed expanding").addClass("expanded"),
									a && a();
						  }));
				};
			}),
				...
				Panda.$body
					.on("click", ".tab .nav-link:not(.no-tab-item)", function (t) {
						...
						if ((t.preventDefault(), !e.hasClass("active"))) {
							var a = $(e.attr("href"));
							a.siblings().removeClass("in active"),
								a.addClass("active in"),
								Panda.slider(a.find(".owl-carousel")),
					...
					Panda.appear(t, function () {
						if (t.classList.contains("appear-animate")) {
							var e = $.extend(
								...
								Panda.parseOptions(t.getAttribute("data-animation-options"))
							);
							Panda.call(function () {
								setTimeout(
									function () {
					...
					Panda.$(t).each(function () {
						...
						t.themeSticky(
							$.extend(
								...
								Panda.parseOptions(t.attr("data-sticky-options"))
							)
						),
			...
			(Panda.ratingTooltip = function (t) {
				for (
					...
					e[i].addEventListener("mouseover", n, { passive: !0 }),
						e[i].addEventListener("touchstart", n, { passive: !0 });
			}),
			(Panda.popup = function (t, e) {
				var a = $.magnificPopup.instance,
					n = $.extend(
						...
						void 0 !== e ? Panda.defaults.popupPresets[e] : {},
						t
					);
				a.isOpen && a.content
					? (a.close(),
			...
			(Panda.initPopups = function () {
				Panda.$body
					.on("click", ".single-product a.submit-review-toggle", function (t) {
						t.preventDefault(),
							Panda.popup({ items: { src: "ajax/review.html" } }, "review");
					})
								...
								callbacks: {
									beforeClose: function () {
										$("#hide-newsletter-popup")[0].checked &&
											Panda.setCookie("hideNewsletterPopup", !0, 7);
									},
								},
							});
						}, 7500);
				...
				if (t) {
					...
					var e = function () {
						if (window.pageYOffset > 400) {
							...
							$("#progress-indicator").length > 0 &&
								$("#progress-indicator").css("stroke-dasharray", n + ", 400");
			...
			(Panda.scrollTo = function (t, e) {
				var a = 0,
					n = void 0 === e ? 600 : e;
				(a = "number" == typeof t ? t : Panda.$(t).offset().top),
					$("html,body").stop().animate({ scrollTop: a }, n);
			}),
			(Panda.orderView = function () {
				$('.order-action .btn[href="#orders-view"]').on("click", function (t) {
					t.preventDefault();
					var e = $(this).parents(".tab-content");
					e.find(".active ").removeClass("active in"),
						e.find("#orders-view").addClass("active in");
				}),
			...
			(Panda.ibNavSurfer = function () {
				$("body").on("click", ".ib-wrapper a:not(.no-tab-item)", function (t) {
					...
					a.find(".tab-pane.active ").removeClass("active"),
						$(e).addClass("active in");
					var n = a.closest(".tab");
					n.find(".nav-link.active").removeClass("active"),
						n.find('[href="' + e + '"]').addClass("active");
				});
			}),
			...
			(Panda.hashScroll = {
						...
						return (
							e.length &&
								...
								$("html, body")
									.delay(600)
									.stop()
									.animate({ scrollTop: e.offset().top }, 600, "easeOutQuad"),
							this
						);
					} catch (t) {
						return this;
				...
				getTarget: function (t) {
					...
					if (0 == t.indexOf("#")) e = $(t);
						...
						-1 != (a = a.substring(a.indexOf("://") + 3)).indexOf("#") &&
			...
			(Panda.sidebar = (function () {
				...
				return (
					(a.prototype.init = function (t) {
						...
						return (
							...
							a.$sidebar.length &&
								...
								a.isNavigation &&
									((e = e.bind(this)), Panda.$window.on("resize", e)),
					...
					(a.prototype.toggle = function () {
						...
						if (
							window.innerWidth >= Panda.minDesktopWidth &&
							t.$sidebar.hasClass("sidebar-fixed")
						) {
							...
							t.isNavigation &&
								...
								t.$sidebar
									...
									.stop()
									.animate(
										{ height: "toggle", "margin-bottom": e ? "toggle" : -6 },
										function () {
											$(this).css("margin-bottom", ""),
												e && t.$sidebar.find(".filter-clean").fadeIn("fast");
										}
									)),
			...
			(Panda.initProductSingle = (function () {
				...
				var e = function (t) {
						...
						a >= e + t.$productThumb[0].offsetHeight
							...
							? (t.$thumbs.css(
									"top",
									parseInt(t.$thumbs.css("top")) - Math.ceil(a - e)
							  ),
							  t.$thumbUp.removeClass("disabled"),
					...
					n = function (t) {
						if (void 0 !== t.$thumbs) {
							...
							(t.thumbsIsVertical =
								t._isPgvertical && window.innerWidth >= Panda.minDesktopWidth),
								t.thumbsIsVertical
									? (t.$thumbs.hasClass("owl-carousel") &&
											t.$thumbs
												.trigger("destroy.owl.carousel")
												.removeClass("owl-carousel"),
									  (t.thumbsHeight =
											t.$productThumb[0].offsetHeight * t.thumbsCount +
											parseInt(t.$productThumb.css("margin-bottom")) *
												(t.thumbsCount - 1)),
									  t.$thumbUp.addClass("disabled"),
									  t.$thumbDown.toggleClass(
											"disabled",
											t.thumbsHeight <= t.$thumbsWrap[0].offsetHeight
									  ),
									  t.isQuickview && i())
									: (e && t.$thumbs.css("top", ""),
									  t.$thumbs.hasClass("owl-carousel") ||
						...
						(s.$wrapper = t),
							...
							o
										...
										(function (t) {
											(t.$thumbs = t.$wrapper.find(".product-thumbs")),
												...
												t.$thumbsDots.on("click", function () {
													var e = $(this),
														a = (
															e.parent().filter(t.$thumbs).length
																? e
																: e.parent()
														).index();
													t.$wrapper
														.find(".product-single-carousel")
														.trigger("to.owl.carousel", a);
												}),
												n(t),
												Panda.$window.on("resize", function () {
													n(t);
								...
								.on("translate.owl.carousel", function (t) {
									var e =
										(t.item.index -
											$(t.currentTarget).find(".cloned").length / 2 +
											t.item.count) %
										t.item.count;
									s.thumbsSetActive(e);
								}),
							"complete" === Panda.status &&
								(Panda.slider(o), Panda.quantityInput(t.find(".quantity"))),
							(function (t) {
							...
							(function (t) {
								t.$wrapper.on("click", ".btn-cart", function (e) {
									...
									(a.closest(".product-popup").length ||
										document.body.classList.contains("home")) &&
										Panda.Minipopup.open({
											...
											price:
												a.find(".product-variation-price").length > 0
													? a
															.find(".product-variation-price")
															.children("span")
															.html()
													: a.find(".product-price .price").html(),
							...
							(function (t) {
								t.$wrapper.on("click", ".btn-compare:not(.open)", function (e) {
									...
									// }),
										$(this).addClass("open"),
										$(this).html(
											'<i class="p-icon-check-solid"></i> BROWSE COMPARE'
										),
					...
					(t.prototype.variationCheck = function () {
						...
						t.$selects.each(function () {
							...
							t.$items.each(function () {
								var t = $(this);
								if (t.children("a:not(.size-guide)").length)
									return t.children(".active").length || (e = !1);
							}),
			...
			(Panda.initProductSinglePage = (function () {
				function t(t) {
					...
					$(".cart-added-alert").remove(),
						$(
							...
							.insertBefore(e)
							.fadeIn(),
						$(this).closest(".product-form-group").length > 0 &&
				...
				function e(t) {
					...
					// 		price:
					// 			e.find(".product-variation-price").length > 0
					// 				? e.find(".product-variation-price").children("span").html()
					// 				: e.find(".product-price").html(),
					// 		actionTemplate:
					// 			'<div class="action-group d-flex mt-3"><a href="#" class="btn btn-sm btn-outline btn-primary btn-block btn-cart mr-2">Add to Cart</a><a href="compare.html" class="btn btn-sm btn-primary btn-block">Compare List</a></div>',
					// 	});
				}
					...
					if (
						...
						var n = e
							...
							i = a
								...
								.data("owl.carousel"),
							s = i
								? (i.current() - i.clones().length / 2 + n.length) % n.length
								: a.find(".product-gallery > *").index();
						if ("undefined" != typeof PhotoSwipe) {
							var o = $(".pswp")[0],
								r = new PhotoSwipe(o, PhotoSwipeUI_Default, n, {
									index: s,
									closeOnScroll: !1,
								});
				...
				function i(t) {
					...
					if ("undefined" != typeof PhotoSwipe) {
						var n = $(".pswp")[0],
							i = new PhotoSwipe(n, PhotoSwipeUI_Default, a, {
								index: e.index(),
								closeOnScroll: !1,
							});
								  ...
								  Panda.$body.on(
										...
										function (t) {
											...
											e.addClass("active").siblings().removeClass("active"),
												...
												e.closest(".rating-form").find("select").val(e.text()),
												t.preventDefault();
										}
								  ),
								  ...
								  void Panda.$body.on("click", ".btn.unlike", function (t) {
										...
										e.toggleClass("active"),
											...
											e
												...
												.find(".btn.like")
												.removeClass("active"),
											e.closest(".feeling").find(".btn.like .count").text("0");
								  }))
							: null
					);
				};
			...
			(Panda.slider = (function () {
				...
				var e = function (t) {
						...
						for (this.classList.remove("row"), s = 0; s < 7; ++s)
							for (e = 1; e <= 12; ++e)
								this.classList.remove("cols" + a[s] + "-" + e);
						if (
							...
							for (var n = this.children, i = n.length, s = 0; s < i; ++s)
								n[s].setAttribute("data-index", s + 1);
					},
					a = function (t) {
						var e,
							...
							.each(function () {
								var t = $(this),
									a = $.extend(
										...
										{},
										Panda.defaults.animation,
										Panda.parseOptions(t.data("animation-options"))
									),
									n = a.duration,
									i = a.delay,
									s = a.name;
					...
					s = function (t) {
						...
						$(t.currentTarget)
							...
							e.hasClass("owl-nav-image-center") &&
								e
									.find(".owl-nav > button")
									.css(
										"top",
										Math.floor(e.find(".product-media img").outerHeight()) / 2
									);
					},
					o = function (t) {
						var e = this,
							...
							if (
								...
								if (
									...
									for (var n = 0; n < e.timers.length; n++)
										Panda.deleteTimeout(e.timers[n]);
									e.timers = [];
								}
									...
									var o = Panda.requestTimeout(
										function () {
											t.css("transition-property", ""),
												...
												e.timers.splice(e.timers.indexOf(o), 1);
										},
										i
											? 1e3 * Number(i.slice(0, -1)) +
				...
				return (
					...
					].onInitialized = Panda.defaults.sliderPresets[
						"product-gallery-carousel"
					].onInitialized =
						t.zoomImage),
					...
					(t.prototype.init = function (t, d) {
						...
						l.forEach(function (t) {
							...
							$.extend(
								!0,
								c,
								Panda.parseOptions(t.attr("data-owl-options")),
								d
							),
							(i = i.bind(this)),
							(o = o.bind(this)),
							...
							t
								...
								.on("initialized.owl.carousel", a)
								.on("translated.owl.carousel", n),
							t.hasClass("animation-slider") &&
								t
									.on("initialized.owl.carousel", i)
									.on("resized.owl.carousel", s)
									.on("translate.owl.carousel", o)
									.on("translated.owl.carousel", r),
							t.owlCarousel(c),
							t.hasClass("owl-nav-image-center") &&
								t
									.find(".owl-nav > button")
									.css(
										"top",
										Math.floor(t.find(".product-media img").outerHeight()) / 2
									);
					}),
					function (e, a) {
				...
				initMenu: function () {
					$(".menu li").each(function () {
						...
						$(".menu > li > a").each(function () {
							var t = $(this);
							"Elements" == t.text() &&
								t.closest("li").addClass("submenu-container");
						}),
						$(".main-nav .megamenu, .main-nav .submenu > ul").each(function () {
							...
							if (t.closest("li").hasClass("submenu-container")) {
								...
								i <= 1300 && t.css("width", i - 40),
									(n = (i - (a = t.innerWidth())) / 2 - e) < 0 &&
										t.css("margin-left", n);
						...
						Panda.$window.on("resize", function () {
							$(".main-nav .megamenu, .main-nav .submenu > ul").each(
								function () {
									...
									if (t.closest("li").hasClass("submenu-container")) {
										var i = $(window).innerWidth();
										i <= 1300 ? t.css("width", i - 40) : t.css("width", 1280),
											(a = t.innerWidth()),
											t.css("margin-left", 0),
											(n = (i - a) / 2 - (e = t.offset().left)) < 0 &&
												t.css("margin-left", n);
									} else n >= 0 && e > 20 && t.css("margin-left", "-=" + n);
								}
							);
				...
				initFilterMenu: function () {
					$(".search-ul li").each(function () {
						if (
							...
							(t.className = "fas fa-chevron-down"),
			...
			(Panda.Minipopup = (function () {
				...
				return {
					...
					open: function (n, r) {
						...
						c.isPurchased
							? (c.detailTemplate = Panda.parseTemplate(c.purchasedTemplate, c))
							: (c.detailTemplate = Panda.parseTemplate(
									null != c.count ? c.priceQuantityTemplate : c.priceTemplate,
									c
							  )),
							null != c.rating &&
								(c.detailTemplate += Panda.parseTemplate(c.ratingTemplate, c)),
							(d = $(Panda.parseTemplate(c.template, c))),
							(l.space = c.space),
							(d.appendTo(t).css("top", -e).find("img")[0].onload =
								function () {
									(e += d[0].offsetHeight + l.space),
										d.addClass("show"),
										d.offset().top - window.pageYOffset < 0 &&
											(l.close(),
											d.css("top", -e + d[0].offsetHeight + l.space)),
										d
			...
			(Panda.Shop = {
					...
					Panda.$body
						.on("click", ".select-menu", function (t) {
							...
							if (!e.hasClass("toolbox-sort")) {
								...
								a.hasClass("fixed")
									? t.stopPropagation()
									: 0 != e.closest(".sidebar-content").length &&
						...
						.on("click", function (t) {
							(0 == $(t.target).closest(".filter-items").length ||
								$(t.target).hasClass("select-menu")) &&
								$(".select-menu").removeClass("opened");
						})
					...
					Panda.$body
						...
						.on(
							...
							function (t) {
								...
								if (s.length > 0)
									(e = $(".panda-compare-table > .compare-row")
										.eq(2)
										.children()
										.eq(s.index())
										.find(".product-price .new-price, .product-price")
										.html()),
										(a = $(".panda-compare-table > .compare-row")
											.eq(1)
											.children()
											.eq(s.index())),
									...
									i.hasClass("product-single") || i.hasClass("product-mini"),
										Panda.Minipopup.open({
											...
											price: i
												.find(
													".product-price .new-price, .product-price .price, .product-price"
												)
												.html(),
											count:
												i.find(".quantity").length > 0
				...
				initRemoveData: function () {
					Panda.$body.on(
						...
						function (t) {
							...
							e.closest("tr").remove(),
								0 == a.find("tr").length &&
									(a.closest(".shop-table").hasClass("wishlist-table")
										? (document.location.href = "wishlist-empty.html")
										: a.closest(".shop-table").hasClass("cart-table") &&
						...
						(e = "load" == a.data("load-type") ? 2 : 1),
							...
							$.ajax({
								...
								success: function (t) {
									var s = $(t);
									setTimeout(function () {
										$.fn.isotope ? n.isotope("insert", s) : n.append(s),
											a.html(i);
										var t = parseInt(
				...
				initProductsScrollLoad: function (t) {
					...
					var i = function (t) {
						window.pageYOffset >
							e + a.outerHeight() - window.innerHeight - 150 &&
							...
							$.ajax({
								...
								success: function (t) {
									...
									a.data("load-count", ++n),
										n > 2 &&
											window.removeEventListener("scroll", i, { passive: !0 });
								},
								failure: function () {
						...
						e.toggleClass("added").addClass("load-more-overlay loading"),
							setTimeout(function () {
								e
									...
									e.hasClass("added")
										? e.attr("title", "Remove from wishlist")
										: e.attr("title", "Add to wishlist");
							}, 500),
							t.preventDefault();
					});
				},
